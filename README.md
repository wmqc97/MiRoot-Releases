...
<h1 align="center">MiRoot V1.9.6</h1>
...
MiRoot 是一个面向具备背屏（副屏）小米手机的 Android 辅助工具，专为小米 17 Pro 等配备背屏的手机设计。它通过 Root / Shizuku 权限与系统接口，实现背屏应用投影、歌词投影、车控增强、充电动画自定义等功能。
...
最新 Release APK 从 Releases 页面获取：

**[https://github.com/wmqc97/MiRoot/releases/latest](https://github.com/wmqc97/MiRoot/releases/latest)**
...
# - 签名密钥（keystore 相关配置）
# - 爱发电 API Token (AFDIAN_USER_ID / AFDIAN_TOKEN)
...
1. 安装 APK 到设备
2. 打开 MiRoot 应用完成权限授权（Root / Shizuku）
